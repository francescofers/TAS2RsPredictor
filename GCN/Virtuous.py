...
- Version 1.12 - 15/05/2024: Bug fix -> pubchem query: Handling case in which the pubchem search return more than a CID (take the first one)
"""
...
def pubchem_query(cpnd, verbose = True ):
    ...
    try:
        ...
        data = file.read()
        file.close()
        # take the first CID if more than one is found
